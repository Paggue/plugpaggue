...
public class PlugPagAuthenticationFragment extends PlugPagFragment
    ...
    if (view != null) {
      ...
      if (id == R.id.plugpag_authentication_toggle_password) {
        ...
        if (validationResult == 0) {
          startAuthenticationTask(this.mEdtEmail.getText().toString(), this.mEdtPassword.getText().toString());
        } else {
    ...
    if (isVisible() && isResumed())
      if (authenticationResult != null && authenticationResult.isAuthenticated()) {
        ...
        if (authenticationResult == null) {
          showSnackbar(getString(R.string.plugpag_authentication_snackbar_error_title),
  ...
  private void togglePasswordVisibility() {
    ...
    if (this.mBtnTogglePassword.getText().equals(getString(R.string.plugpag_authentication_button_show_password))) {
